		...
		<div class="row">
			<div class="span12">
				...
				<p>
					...
					Телефоны: 8 (863) 246-43-54, +7 (951) 522-82-94 <br />
					<!--<strong>Горячая линия</strong>: 8 800 707-00-97 <br />-->
					e-mail: <?= safe_mailto('info@roscentrdpo.ru', 'info@roscentrdpo.ru') ?> <br />
					www.roscentrdpo.ru
				</p>
				<p>
					Режим работы: пн-чт — 9:00-18:00, пт — 9:00-16:45, обед — 13:00-13:45
				</p>
				<p>
				...
				<!--
				<p>
					<strong>Региональный представитель в Самарской области, г. Самара</strong> <br />
					Малинина Ирина Александровна  <br/> тел. +7 (937) 995-54-48 <br />
					email: <?= safe_mailto('roscentrdpo63@gmail.com','roscentrdpo63@gmail.com');?> <br />
				</p>
				<p>
