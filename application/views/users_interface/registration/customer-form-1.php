		...
		<div class="span6" style="margin-left:0px;">
			<fieldset>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" id="manager" class="span3 input-popover inpval" data-content="Введите должность руководителя Вашей организации в родительном падеже.<br/><strong>Например:</strong> Директорa" data-trigger="focus" data-placement="<?=POPUP_POSITION;?>" data-toggle="popover" data-original-title="Обязательное поле" name="manager" value="<?=$this->session->userdata('manager')?>"> <span class="badge badge-info">!</span>
						<span class="help-inline" style="display:none;">&nbsp;</span>
						<p class="help-block">Директорa</p>
					</div>
				</div>		
				<div class="control-group">
