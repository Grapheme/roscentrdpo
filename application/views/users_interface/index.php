...
<div class="container">
    <div class="row">
        <div id="promo-banner" class="span12">
            <h1>Южно-окружной центр повышения квалификации и переподготовки кадров <br/>для строительного и
                жилищно-коммунального комплекса</h1>
        ...
        <div class="promo-12 span12">
            ...
            <div class="wrapp_">
					<span class="scrollingtext">
                        Уважаемые коллеги, сердечно поздравляем с днем строителя! Желаем Вам и Вашим семьям здоровья, успехов и удачи в Вашей нелегкой работе!
<!--						Обучение новым Правилам по охране труда при работе на высоте. Стоимость 2800 руб. и другим рабочим специальностям.-->
					</span>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="span12">
            <div class="row review">
                ...
                <ul class="partners">
                    <li class="p1"><a title="Национальное объединение строителей" href="http://www.nostroy.ru/"
                                      target="_blank">Национальное объединение строителей</a></li>
                    <li class="p2"><a title="Национальное объединение проектировщиков" href="http://www.nop.ru/"
                                      target="_blank">Национальное объединение проектировщиков</a></li>
                    <li class="p3"><a title="Национальное объединение изыскателей" href="http://www.iziskately.ru/"
                                      target="_blank">Национальное объединение изыскателей</a></li>
                    <li class="p4"><a title="Национальное объединение энергоаудиторов" href="http://no-e.ru/"
                                      target="_blank">Национальное объединение энергоаудиторов</a></li>
                    <li class="p5"><a title="МЧС России" href="http://www.mchs.gov.ru/" target="_blank">МЧС России</a>
                    </li>
                    <li class="p6"><a title="Министерство труда РФ" href="http://www.rosmintrud.ru/" target="_blank">Министерство
                            труда РФ</a></li>
                </ul>
            </div>
        </div>
        <div class="span9">
            <p>
                В условиях современной рыночной экономики постоянная профессиональная переподготовка, повышение
                квалификации и получение дополнительного
                профессионального образования — это не просто важное, а, без преувеличения, обязательное условие
                выполнения требований федеральных
                законодательств, что в свою очередь способствует выживанию и успешному развитию любого бизнес-проекта.
                Южно-окружной центр повышения
                квалификации нацелен на решение именно этой актуальной задачи. С помощью образовательного портала нами
                успешно реализуется комплексная
                программа повышения квалификации.
            </p>

            <p>
                Образовательный портал АНО ДПО Южно-окружной центр повышения квалификации и переподготовки кадров для
                строительного и жилищно-коммунального
                комплекса предлагает курсы дистанционного дополнительного профессионального образования по направлениям
                строительства, проектирования,
                инженерных изысканий, коммунального хозяйства, энергетического менеджмента, охраны труда,
            ...
            <p>
                ...
                учебных курсов в дистанционной форме
                через сети Интернет. После окончания обучения и успешной сдачи итогового тестирования слушатели курсов в
                самые кратчайшие сроки получают
    ...
    <div class="row">
        ...
        <div class="span12">
            <p>
                Южно-окружной центр повышения квалификации располагается в Ростове-на-Дону, но охватывает своей
                деятельностью не
                только Ростов, Ростовскую область и близлежащие регионы, а территорию всей России в целом. Все это стало
                возможным
                благодаря новым технологиям дистанционного обучения которые не имеют территориальных ограничений. Все
                что нужно
                специалисту - это свободный доступ в интернет. Поэтому дистанционная форма обучения, сегодня сверх
                актуальна, потому
                что позволяет повысить квалификацию и получить всю необходимую документацию без отрыва от основной
                деятельности.
                Дистанционное обучение – это, своего рода, палочка выручалочка для человека, загруженного работой,
                который не имеет
                возможности оторваться на время обучения от своей профессиональной деятельности. Особенно характерно для
                строительной отрасли.
            </p>

            <p>
                Специалисты, прошедшие наши курсы повышение квалификации успешно работали на Олимпийский стройках Сочи,
                что
                составляет нашу особую гордость. Мы смело можем записать себе в актив повышение квалификации работников
                строительной,
                проектной отраслях, и сферы ЖКХ в городах: Пятигорск, Элиста, Майкоп, Махачкала, Чечня, Краснодар,
                Ставрополь,
                Волгоград, Астрахань, Воронеж, Хабаровск, Челябинск, Севастополь, Симферополь (Республика Крым) и это
                далеко
                неполный перечень.
            </p>

            <p>
                Наша работа – это повышение квалификации кадров и мы стараемся выполнять ее, как и Вы, свою,
                добросовестно и с наибольшей пользой.
            </p>
        </div>
    </div>
</div>
