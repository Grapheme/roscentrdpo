			...
			<div class="promo-12 span12">
				...
				<div class="wrapp_">
					...
					<span class="scrollingtext">
						Предлагаем сотрудничество региональных представителей на выгодных условиях. Обучение по курсу "Охрана труда" 1500 руб.
					</span>
					-->
					<span class="scrollingtext">
						Уважаемые коллеги! Поздравляем Вас с наступающим Новым годом и Рождеством. Желаем Вам в новом году роста и процветания, постоянного развития и крепкого здоровья! 
					</span>
				</div>
			</div>
		</div>
