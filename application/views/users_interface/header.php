		...
		<div class="row">
			<nav class="span12">
				<ul>
					...
					<li><?=anchor('information','О центре обучения');?> <span class="lsep"> </span><span class="rsep"> </span></li>
				...
				<?php endif; ?>
					<li nav="registration"><?=anchor('news','Новости');?> <span class="lsep"> </span><span class="rsep"> </span></li>
