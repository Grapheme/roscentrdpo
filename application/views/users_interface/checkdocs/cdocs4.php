	...
	<div class="container">
		<div class="row">
			<div class="span12">
				...
				<div class="clear"> </div>
				<p>
					АНО ДПО «Южно-окружной центр повышения квалификации» располагает квалифицированным 
					<a target="_blank" href="<?=base_url();?>documents/2014/kadri.pdf">составом работников</a>, обеспечивающих высокий уровень подготовки обучаемых.					
				</p>
			</div>
