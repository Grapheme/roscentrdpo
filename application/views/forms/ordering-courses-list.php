<?=form_open(uri_string(),array('class'=>'form-horizontal','id'=>'form-choise-trend-course')); ?>
	<fieldset>
					...
					<div class="controls">
						<table class="table table-striped">
							...
							<?php for($i=0;$i<count($courses);$i++):?>
								<tr>
									<td><input autocomplete="off" class="trend-courses" type="checkbox" name="course[]" value="<?=$courses[$i]['id']?>" /></td>
