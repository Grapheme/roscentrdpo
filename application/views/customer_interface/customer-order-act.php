		...
		<div class="row">
			<div class="span12">
				...
				<p class="intend">
			      ...
			      действующей на основании доверенности <?=documentLicenseDate($order['closedate_original']);?>,
			      с одной стороны, и <?=$customer['organization'];?>, в лице <?=$customer['manager'];?> <?=$customer['fiomanager'];?>, действующего на 
