		...
		<div class="row">
			<div class="span12">
                ...
                if(!empty($customer['passport_number'])):
                    $passport_data = '(паспорт серия <u>'.$customer['passport_seria'].'</u> и №<u>'.$customer['passport_number'].'</u>, выдан <u>'.$customer['passport_data'].'</u>)';
                endif;
                ?>
				...
				для строительного и жилищно-коммунального комплекса» (лицензия Региональной службы
				...
				и <?=$customer['fio'];?> <?=$passport_data;?> в дальнейшем «Заказчик», с другой стороны, в дальнейшем при совместном
