...
class Users_interface extends MY_Controller{
	...
	public function news(){
		...
		$pagevar = array(
			'title'			=> 'Новости | Южный окружной центр дистанционного электронного образования',					
			'description'	=> '',
			'author'		=> '',
			'baseurl' 		=> base_url(),
			'loginstatus'	=> $this->loginstatus,
	...
	public function centerdocs(){
		
		$pagevar = array(
			'title'			=> 'Документы центра | Аккредитация министерством труда',					
